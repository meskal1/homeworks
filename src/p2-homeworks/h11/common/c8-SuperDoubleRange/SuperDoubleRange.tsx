...
export const SuperDoubleRange: React.FC<SuperDoubleRangePropsType> = ({ onChangeRange, value, threshold, step, isDisabled }) => {
  ...
  return (
    <>
      <input
        style={{
          background: `linear-gradient(to right, #eee ${minValueBackgroundGradient}%, #0075FF ${minValueBackgroundGradient}%, #0075FF ${maxValueBackgroundGradient}%, #eee ${maxValueBackgroundGradient}%)`,
        }}
        type={'range'}
        id='input1'
        min={threshold[0]}
